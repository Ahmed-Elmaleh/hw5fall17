...
This directory contains the Rotten Potatoes rails app that we will use
as the starting point for HW5.

You can copy this directory to your Cloud9 wokspace by first forking this
GitHub repo to your GitHub account and then cloning it to your Cloud9 workspace.  You should
